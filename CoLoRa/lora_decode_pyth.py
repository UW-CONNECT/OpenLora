...
#HEllow world messages for testing the functions
#symb_message_sf12 = [1000, 48, 992, 496, 656, 3112, 3928, 2224, 998, 3212, 1486, 2898, 651, 2139, 4018, 2887, 33, 1186, 1790, 902, 245, 3563, 1828]
#symb_message_sf8 = [20,48,    28,    12,    44,   196,   244,   136,    99,    48,    27 ,   21 ,  157,    62,   200,   220,   202,   183,    91,   178,   184,    30,    66,    23,    96,   163,    51,   167,   111,    56,   143,   161,    77]
#symb_osama = [37, 9, 1, 113, 221, 193, 69, 213, 157, 49, 28, 11, 52, 195, 183, 244, 180, 97, 137, 166, 122, 1, 67, 234, 25, 66, 77, 37, 225, 139, 223, 194, 120, 216, 36, 55, 251, 7, 163, 184, 65, 62, 51]
#SF = 8
#message = lora_decoder(np.add(symb_osama,-1), SF)
#print("Message -1:")
#print(message)
#for i in message: print(chr(int(i)), end =" ")
